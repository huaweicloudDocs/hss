...
<td class="cellrowborder" valign="top" width="78.03%" headers="mcps1.2.3.1.2 "><p id="p2237018710298"><a name="p2237018710298"></a><a name="p2237018710298"></a>企业主机安全需要安装客户端才能使用，具体操作请参见<a href="安装客户端.md">安装客户端</a>。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="78.03%" headers="mcps1.2.3.1.2 "><p id="p32749249103349"><a name="p32749249103349"></a><a name="p32749249103349"></a>在开启主机防护前，可以自定义安全配置，包括：配置常用登录地、配置SSH登录IP白名单、配置自定义弱口令和网站后门检测设置。具体操作请参见<a href="（可选）安全配置.md">（可选）安全配置</a>。</p>
</td>
</tr>
