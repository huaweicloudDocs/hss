# 查看和处理应用进程事件<a name="hss_01_0055"></a>
...
## 查看进程告警事件<a name="section14590215112313"></a>
...
3.  进入“程序运行认证“页面，选择“事件管理“，如[图2](#fig105477442559)所示。
    ...
    **图 2**  进程事件管理页面<a name="fig105477442559"></a>  
    ![](figures/进程事件管理页面.png "进程事件管理页面")
    ...
    **表 1**  进程事件管理
    ...
    <tbody><tr id="row524331355617"><td class="cellrowborder" valign="top" width="16.919999999999998%" headers="mcps1.2.3.1.1 "><p id="p1244181316568"><a name="p1244181316568"></a><a name="p1244181316568"></a>事件类型</p>
    </td>
    <td class="cellrowborder" valign="top" width="83.08%" headers="mcps1.2.3.1.2 "><p id="p724471305615"><a name="p724471305615"></a><a name="p724471305615"></a>进程告警事件的类型。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="83.08%" headers="mcps1.2.3.1.2 "><p id="p1416112835713"><a name="p1416112835713"></a><a name="p1416112835713"></a>告警事件的状态，包括<span class="parmvalue" id="parmvalue177941756131112"><a name="parmvalue177941756131112"></a><a name="parmvalue177941756131112"></a>“已处理（标记）”</span>和<span class="parmvalue" id="parmvalue10309659141118"><a name="parmvalue10309659141118"></a><a name="parmvalue10309659141118"></a>“隔离查杀”</span>。</p>
    </td>
    </tr>
    <tr id="row157221045154316"><td class="cellrowborder" valign="top" width="16.919999999999998%" headers="mcps1.2.3.1.1 "><p id="p14723134519433"><a name="p14723134519433"></a><a name="p14723134519433"></a>简述</p>
    </td>
...
## 处理进程告警事件<a name="section4340842207"></a>
