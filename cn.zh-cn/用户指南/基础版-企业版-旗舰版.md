...
<td class="cellrowborder" valign="top" headers="mcps1.1.4.1.2 "><p id="p2176173491810"><a name="p2176173491810"></a><a name="p2176173491810"></a>通过程序特征、行为检测，结合AI图像指纹算法以及云查杀，有效识别后门、木马、挖矿软件、蠕虫和病毒等恶意程序，也可检测出主机中未知的恶意程序和病毒变种，并提供一键隔离查杀能力。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" headers="mcps1.1.4.1.2 "><p id="p8280131765919"><a name="p8280131765919"></a><a name="p8280131765919"></a>通过程序特征、行为检测，结合AI图像指纹算法以及云查杀，有效识别后门、木马、挖矿软件、蠕虫和病毒等恶意程序，也可检测出主机中未知的恶意程序和病毒变种，并提供一键隔离查杀能力。</p>
</td>
</tr>
