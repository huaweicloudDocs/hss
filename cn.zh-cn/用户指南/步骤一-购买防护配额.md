...
-   配额只能在购买时所选择的区域使用。
-   企业版/旗舰版需要全部主机部署，不支持只为部分主机开通企业版/旗舰版功能。

    为了保证云上主机的安全性，您需要为您账号下的所有主机同时开通企业版/旗舰版功能，**即企业版/旗舰版的配额数量需等于您所拥有的ECS/BMS数量**。
...
4.  在“购买主机安全配额“界面，设置配额的规格。
    ...
    2.  选择版本。
        ...
        支持“基础版“、“企业版“、“网页防篡改版“和“旗舰版“。版本之间的差异请参见[服务版本](https://support.huaweicloud.com/productdesc-hss/hss_01_0136.html)。
