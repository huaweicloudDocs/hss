...
<td class="cellrowborder" valign="top" width="74.19%" headers="mcps1.2.3.1.2 "><p id="p542844617342"><a name="p542844617342"></a><a name="p542844617342"></a>根据CIS标准并结合华为多年最佳安全实践进行检测。</p>
<p id="p1243163814"><a name="p1243163814"></a><a name="p1243163814"></a>目前支持的配置检测类型有：Tomcat、SSH、Nginx、Redis、Apache2、MySQL5。</p>
</td>
</tr>
</tbody>
</table>
