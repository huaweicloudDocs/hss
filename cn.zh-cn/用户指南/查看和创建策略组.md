...
## 注意事项<a name="section1650952211914"></a>
...
<td class="cellrowborder" valign="top" width="37.913791379137905%" headers="mcps1.1.7.1.2 "><div class="p" id="p11647175417020"><a name="p11647175417020"></a><a name="p11647175417020"></a>提权检测包含<span class="parmvalue" id="parmvalue13236285311"><a name="parmvalue13236285311"></a><a name="parmvalue13236285311"></a>“进程提权检测”</span>和<span class="parmvalue" id="parmvalue116416311231"><a name="parmvalue116416311231"></a><a name="parmvalue116416311231"></a>“文件提权检测”</span>。<a name="ul134213493417"></a><a name="ul134213493417"></a><ul id="ul134213493417"><li>支持对利用SUID程序漏洞进行root提权的检测。</li><li>支持对利用内核漏洞进行root提权的检测。</li><li>支持对文件提权的检测。</li></ul>
</div>
</td>
...
<td class="cellrowborder" valign="top" width="37.913791379137905%" headers="mcps1.1.7.1.2 "><p id="p92452053165615"><a name="p92452053165615"></a><a name="p92452053165615"></a>提供系统关键文件变更检测及文件完整性校验，确保系统关键文件的安全可信。</p>
</td>
